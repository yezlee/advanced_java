...
public class ex1 {
	...
	public static void main(String[] args) {
		...
		for(int i = 2; i <= 6; i++) {           //첫번째 i포문
			for(int j = 6; j >= 2; j--) {       //첫번째 j포문        
				if(i <= j) {
					System.out.print(" ");
				}else {
					System.out.print("*");
